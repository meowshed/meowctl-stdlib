...
# PM kwargs: none
#
# uv tools are installed via `mise use --global pipx:<name>`.
# mise's pipx backend uses uv when available (auto mode), so this
# delegates both installation and PATH management to mise entirely.
